...
const char __far startup_banner[] =
    "\016lqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqk\017\n\016x\017  JRC-1 65816 "
    "Single Board Computer  \016x\017\n\016x\017  jrcOS Version %d.%d.%d "
    "(%-10.10s)   "
